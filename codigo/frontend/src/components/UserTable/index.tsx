...
export const UserTable: React.FC<UserTableProps> = ({ users, handleUpdateUser, handleDeleteUser }: UserTableProps) => {
    ...
    const setTableBgColor: string = colorMode === LIGHT ? colors.light.Nord5 : colors.dark.Nord1;
